...
**Keywords:** vortex ring · drone aerodynamics · CFD · fluid dynamics · propeller · Matplotlib simulation · Python

Interactive Python simulation of **vortex-ring / aerodynamics** behavior generated by a drone under different thrust profiles — a reduced-order fluid-dynamics model for propeller wake rings (feeds [NeuralVortex](https://github.com/Siddarthb07/NeuralVortex)).
